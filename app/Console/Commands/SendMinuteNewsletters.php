...
/**
 * Class SendMinuteNewsletters
 * @package App\Console\Commands
 * 
 * This command sends cryptocurrency newsletters to subscribers who have
 * selected 'minute' frequency. It fetches current cryptocurrency data
...
class SendMinuteNewsletters extends Command
{
     ...
     * 
     * Fetches all minute-frequency subscribers, retrieves current cryptocurrency data,
